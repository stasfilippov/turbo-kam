	...
	return (
		<section>
			<div className='max-container mt-20'>
				<h1 className='text-white-10 medium-48 mb-7' ><span className='text-pink-primary'>Турбо Кам Сервис -</span> О компании</h1>
				<div className='bg-gray-10 rounded-5xl p-10' >
					<ResizablePanelGroup direction="horizontal" className='gap-4'>
						...
						<ResizablePanel defaultSize={75}>
							...
							<p className='medium-16 mb-3'>Я, Марат Сабирзянович, руководитель компании &quot;Турбо Кам Сервис&quot;. Наш центр по ремонту турбин не отстает от современного темпа развития. Мы стремимся к улучшению качества предоставляемых услуг.</p>
